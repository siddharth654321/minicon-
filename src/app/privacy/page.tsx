...
const Privacy = () => {
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', padding: '2rem' }}>
      ...
      <ul style={{ fontSize: '1.1rem', color: '#222', marginLeft: '1.5rem', marginBottom: '2rem', lineHeight: 1.7 }}>
        <li>We collect and have collected over the past 12 months personal information about you from a variety of sources, as set out below. The information that we collect and use varies depending on how you interact with us.</li>
        <li>We may use information we collect about you to communicate with you, provide the Services, comply with any applicable legal obligations, enforce any applicable terms of service, and to protect or defend the Services, our rights, and the rights of our users or others.</li>
      </ul>
      ...
      <ul style={{ fontSize: '1.1rem', color: '#222', marginLeft: '2rem', marginBottom: '1.5rem', lineHeight: 1.7 }}>
        ...
        <li>Some features of the Services may require you to directly provide us with certain information about yourself. You may elect not to provide this information, but doing so may prevent you from using or accessing these features.</li>
      </ul>
      ...
      <h2 style={{ fontSize: '1.3rem', fontWeight: 600, marginTop: '2rem' }}>Cookies</h2>
      <ul style={{ fontSize: '1.1rem', color: '#222', marginLeft: '1.5rem', marginBottom: '2rem', lineHeight: 1.7 }}>
        <li>We use Cookies to power and improve our Site and our Services (including to remember your actions and preferences), to run analytics and better understand user interaction with the Services.</li>
        <li>We may also permit third parties and services providers to use Cookies on our Site to better tailor the services, products and advertising on our Site and other websites.</li>
        <li>Most browsers automatically accept Cookies by default, but you can choose to set your browser to remove or reject Cookies through your browser controls. Removing or blocking Cookies can negatively impact your user experience and may cause some of the Services, including certain features and general functionality, to work incorrectly or no longer be available.</li>
        <li>Blocking Cookies may not completely prevent how we share information with third parties such as our advertising partners.</li>
      </ul>
      <h2 style={{ fontSize: '1.3rem', fontWeight: 600, marginTop: '2rem' }}>User Generated Content</h2>
      <ul style={{ fontSize: '1.1rem', color: '#222', marginLeft: '1.5rem', marginBottom: '2rem', lineHeight: 1.7 }}>
        <li>The Services may enable you to post product reviews and other user-generated content. If you choose to submit user generated content to any public area of the Services, this content will be public and accessible by anyone.</li>
        <li>We do not control who will have access to the information that you choose to make available to others, and cannot ensure that parties who have access to such information will respect your privacy or keep it secure.</li>
        <li>We are not responsible for the privacy or security of any information that you make publicly available, or for the accuracy, use or misuse of any information that you disclose or receive from third parties.</li>
      </ul>
      <h2 style={{ fontSize: '1.3rem', fontWeight: 600, marginTop: '2rem' }}>Third Party Websites and Links</h2>
      <ul style={{ fontSize: '1.1rem', color: '#222', marginLeft: '1.5rem', marginBottom: '2rem', lineHeight: 1.7 }}>
        <li>Our Site may provide links to websites or other online platforms operated by third parties. If you follow links to sites not affiliated or controlled by us, you should review their privacy and security policies and other terms and conditions.</li>
        <li>We do not guarantee and are not responsible for the privacy or security of such sites, including the accuracy, completeness, or reliability of information found on these sites.</li>
      ...
      <h2 style={{ fontSize: '1.3rem', fontWeight: 600, marginTop: '2rem' }}>Your Rights and Choices</h2>
      <ul style={{ fontSize: '1.1rem', color: '#222', marginLeft: '1.5rem', marginBottom: '2rem', lineHeight: 1.7 }}>
        ...
        <li>You may exercise any of these rights where indicated on our Site or by contacting us using the contact details provided below.</li>
        <li>We will not discriminate against you for exercising any of these rights. We may need to collect information from you to verify your identity, such as your email address or account information, before providing a substantive response to the request. In accordance with applicable laws, You may designate an authorized agent to make requests on your behalf to exercise your rights. Before accepting such a request from an agent, we will require that the agent provide proof you have authorized them to act on your behalf, and we may need you to verify your identity directly with us. We will respond to your request in a timely manner as required under applicable law.</li>
      </ul>
      <h2 style={{ fontSize: '1.3rem', fontWeight: 600, marginTop: '2rem' }}>Complaints</h2>
      <ul style={{ fontSize: '1.1rem', color: '#222', marginLeft: '1.5rem', marginBottom: '2rem', lineHeight: 1.7 }}>
        <li>If you have complaints about how we process your personal information, please contact us using the contact details provided below.</li>
        <li>If you are not satisfied with our response to your complaint, depending on where you live you may have the right to appeal our decision by contacting us using the contact details set out below, or lodge your complaint with your local data protection authority.</li>
      </ul>
      ...
      <ul style={{ fontSize: '1.1rem', color: '#222', marginLeft: '1.5rem', marginBottom: '2rem', lineHeight: 1.7 }}>
        <li>Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call or email us at <a href="mailto:support@abc.com">support@abc.com</a> or contact us at Kolkata, India.</li>
      </ul>
    </div>
  )
}
